...
import 'package:test_sejutacita/core/service/extension.dart';
import 'package:test_sejutacita/widgets/button/chooser_button.dart';
import 'package:test_sejutacita/widgets/button/paging_button.dart';
import 'package:test_sejutacita/widgets/circle_small.dart';
import 'package:test_sejutacita/widgets/custom_icon.dart';
import 'package:test_sejutacita/widgets/eyeslash_icon.dart';
import 'package:test_sejutacita/widgets/item_shimmer.dart';
import 'package:test_sejutacita/widgets/text/text.dart';
import 'package:test_sejutacita/widgets/text/text_field.dart';
    ...
    switch (type) {
      case 0:
        return BlocBuilder<RepoDataBloc, RepoDataState>(
          ...
          return Center(
            child: Container(child: text16Bold(title: 'Tidak ada Data')),
          );
        });
      ...
      case 1:
        return BlocBuilder<IssueDataBloc, IssueDataState>(
          ...
          if (state is IssueDataClear) {
            return text16Bold(title: 'load index');
          }
